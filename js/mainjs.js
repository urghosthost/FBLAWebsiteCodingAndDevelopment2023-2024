...
function section(sectionName, backgroundcolor, fColor, animationName, imageLocation, imageAltText, orientation, header, pText, bText, bGoTo) {
...
function checkForm() {
  ...
  checkFormInput(refName1, 'refname1label', "Please enter your first reference's name.");

  checkFormInput(relation1, 'relation1label', "Please enter your first reference's relation.");

  checkFormInput(number1, 'number1label', "Please enter your first reference's phone number.");

  checkFormInput(refName2, 'refname2label', "Please enter your second reference's name.");

  checkFormInput(relation2, 'relation2label', "Please enter your second reference's relation.");

  checkFormInput(number2, 'number2label', "Please enter your second reference's phone number.");

  checkFormInput(reason, 'reasonlabel', "Please enter your reason for applying.");

  checkFormInput(sDate1, 'sdate1label', "Please enter your most recent employment's start date.");

  checkFormInput(eDate1, 'edate1label', "Please enter your most recent employment's end date.");

  checkFormInput(jobTitle1, 'jobtitle1label', "Please enter your most recent employment's job title.");

  checkFormInput(company1, 'company1label', "Please enter your most recent employment's company name.");

  checkFormInput(city1, 'city1label', "Please enter the city of your most recent employment.");

  checkFormInput(state1, 'state1label', "Please enter the state of your most recent employment.");

  checkFormInput(jobDes1, 'jobdes1label', "Please enter the description of your most recent employment.");
